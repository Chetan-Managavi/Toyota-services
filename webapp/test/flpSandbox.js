		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Toyota",
									"targetURL": "#assignmenttoyota-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assignmenttoyota-display": {
								"semanticObject": "assignmenttoyota",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assignment.toyota",
									"url": sap.ui.require.toUrl("assignment/toyota")
								}
							}
						}
					}
